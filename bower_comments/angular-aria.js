 ...
 * @description
 *
 * The `ngAria` controller provides support for common
 ...
 * ## Usage
 *
 * For ngAria to do its magic, simply include the controller `ngAria` as a dependency. The following
 ...
 * | {@link controller:ngMessages ngMessages}        | aria-live                                                                                           |
 ...
 *
 * ```js
 * angular.controller('myApp', ['ngAria'], function config($ariaProvider) {
 *   $ariaProvider.config({
 *     ariaValue: true,
 *     tabindex: false
 *   });
 ...
 *
 * ## Dependencies
 * Requires the {@link ngAria} controller to be installed.
 *
 */
function $AriaProvider() {
   ...
   * }])
   *```
   * Shown above, the ngAria controller creates a directive with the same signature as the
   ...
   * simply as a silent side-effect of using `ng-disabled` with the ngAria controller.
   *
