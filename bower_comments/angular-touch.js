 ...
 * @description
 *
 * The `ngTouch` controller provides helpers for touch-enabled devices.
 ...
 * @deprecated
 * sinceVersion="1.7.0"
 * The ngTouch controller with the {@link ngTouch.$swipe `$swipe`} service and
...
// define ngTouch controller
/* global ngTouch */
var ngTouch = angular.module('ngTouch', []);

ngTouch.info({ angularVersion: '1.7.5' });
...
/* global ngTouch: false */
     ...
     * sinceVersion="1.7.0"
     *
     * See the {@link ngTouch controller} documentation for more information.
     *
     * @description
     * The `$swipe` service is a service that abstracts the messier details of hold-and-drag swipe
     * behavior, to make implementing swipe-related directives more convenient.
     *
     * Requires the {@link ngTouch `ngTouch`} controller to be installed.
     *
