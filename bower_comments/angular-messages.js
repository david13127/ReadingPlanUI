 ...
 * @description
 *
 * The `ngMessages` controller provides enhanced support for displaying messages within templates
 ...
 *
 * Currently, the ngMessages controller only contains the code for the `ngMessages`, `ngMessagesInclude`
 ...
 *
 * ## Animations
 * If the `ngAnimate` controller is active within the application then the `ngMessages`, `ngMessage` and
...
angular.module('ngMessages', [], function initAngularHelpers() {
   ...
   * {@link controller:ngMessages `ngMessages` controller documentation}.
   *
   * @usage
   * ```html
   * <!-- using attribute directives -->
