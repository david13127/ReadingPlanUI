 ...
 * @description
 *
 * The `ngParseExt` controller provides functionality to allow Unicode characters in
 * identifiers inside AngularJS expressions.
 *
 * This controller allows the usage of any identifier that follows ES6 identifier naming convention
 * to be used as an identifier in an AngularJS expression. ES6 delegates some of the identifier
 * rules definition to Unicode, this controller uses ES6 and Unicode 8.0 identifiers convention.
 *
 */
