 ...
 * @description
 *
 * The `ngResource` controller provides interaction support with RESTful services
 ...
 *
 * ## Dependencies
 * Requires the {@link ngResource } controller to be installed.
 *
 */
 ...
 *
 * Requires the {@link ngResource `ngResource`} controller to be installed.
 *
 ...
 *
   ```js
      var app = angular.controller('app', ['ngResource']);
